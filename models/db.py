...
db.define_table('user_address', 
                    ...
                    Field('postcode', 'string', requires=[IS_NOT_EMPTY(), IS_LENGTH(7)]),
                )
db.define_table('user_credit_card', 
                    Field('card_number', 'string', requires=[IS_NOT_EMPTY(), IS_LENGTH(12)]),
                    Field('identifying_code', 'string', requires=[IS_NOT_EMPTY(), IS_LENGTH(3)]),
